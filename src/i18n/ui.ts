...
export const ui = {
	...
	services: "Services",
	homepage: "Homepage",
	"tagline": "私の目標は、知的でモダン、そしてインパクトのあるデジタル体験を創り出すことです。クリーンなデザイン、シームレスな機能性、そしてスマートなAI統合を融合させ、見た目が美しいだけでなく“賢く動く”アプリやシステムを構築します。Flutterアプリ、ディープラーニングモデル、フルスタックプロジェクトのいずれであっても、私の目的はただ一つ — アイデアを強力で効率的、かつユーザー中心のソリューションへと形にすることです。",
	...
	"apps.title": "機械学習 (ML)",
	"uiux.title": "深層学習 (DL)",
	"seo.title": "研究 (Research)",
	"advertising.title": "開発 (Dev)",
